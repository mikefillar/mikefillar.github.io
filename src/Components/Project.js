...
const Project = () => {
  return (
    <section
      className="flex flex-col md:flex-row justify-center items-center m-5 p-3 sm:m-7 sm:p-10 md:p-15 semilarge:px-32 semilarge:m-15  semilarge:gap-20 gap-5 sm:gap-12 md:gap-15 h-auto transition-all duration-500 ease-in-out bg-color-body"
      id="project"
    >
